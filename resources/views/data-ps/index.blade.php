...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- Buttons for Import and Add -->
            <div class="d-flex justify-content-between mb-4">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#importModal">Import
                    Excel</a>
                <a href="{{ route('data-ps.create') }}" class="btn btn-primary">Add New Data</a>
                <a href="{{ route('data-ps.sto-analysis') }}" class="btn btn-info">STO Analysis</a>
            </div>
                        ...
                        <tbody>
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->STO }}</td>
                                    <td>
                                        <a href="{{ route('data-ps.show', $item->id) }}"
                                            class="btn btn-primary btn-sm">View</a>
                                        <a href="{{ route('data-ps.edit', $item->id) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <form action="{{ route('data-ps.destroy', $item->id) }}" method="POST"
